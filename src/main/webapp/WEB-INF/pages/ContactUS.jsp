    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content animate">
                ...
                <p>Reach out to our team for support, inquiries, or feedback about our decentralized energy trading platform.</p>
            </div>
        </div>
    </section>
    ...
    <section class="contact">
        <div class="container">
            <div class="section-header">
                ...
                <p>We're here to help you navigate the future of energy trading</p>
            </div>
            <div class="contact-content animate">
                ...
                <div class="contact-info">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            <h4>Address</h4>
                            <p>123 Energy Plaza, Tech City, TC 12345</p>
                        </div>
                    </div>
                    <div class="info-item">
                        <div class="info-icon">📞</div>
